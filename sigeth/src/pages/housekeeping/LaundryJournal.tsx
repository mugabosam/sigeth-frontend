    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">
          {t("laundryJournal")} — Ljlaundry.prt
        </h1>
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
            {filtered.map((j, i) => (
              <tr key={i} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-3 font-mono">{j.room_num}</td>
                <td className="px-4 py-3">{j.designation}</td>
          ...
          <tfoot className="bg-amber-50 border-t">
            <tr>
              <td colSpan={6} className="px-4 py-3 font-semibold text-right">
                {t("grandTotal")}
              </td>
