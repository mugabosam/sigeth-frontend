          ...
          {selected && (
            <div className="bg-white rounded p-4 space-y-4">
              ...
              <div className="p-3 bg-hotel-cream border border-hotel-border rounded flex gap-2">
                <Info
                  size={16}
                  className="text-hotel-gold flex-shrink-0 mt-0.5"
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-hotel-text-secondary mb-1">
                    Lot{" "}
                    <span className="text-hotel-text-secondary text-xs">[System]</span>
                  </label>
                  <input
                    type="number"
                    value={selected.lot}
                    disabled
                    className="w-full border border-gray-300 bg-white rounded px-3 py-2 text-xs"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-hotel-text-secondary mb-1">
              ...
              <div className="border-t border-hotel-border pt-4">
                <h4 className="text-sm font-semibold text-hotel-text-primary mb-4 uppercase tracking-wide">
                  Service Details
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="md:col-span-2">
                    <label className="block text-xs font-medium text-hotel-text-secondary mb-1">
                      Designation <span className="text-hotel-gold">*</span>
                    </label>
                    <input
                      type="text"
                      value={selected.item}
                  ...
                  <div>
                    <label className="block text-xs font-medium text-hotel-text-secondary mb-1">
                      Unity <span className="text-hotel-gold">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-medium text-hotel-text-secondary mb-1">
                      Quantity <span className="text-hotel-gold">*</span>
                    </label>
                    <input
                      type="number"
                      value={selected.qty || ""}
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.map((b, i) => (
                  ...
                  >
                    <td className="py-2 px-2 font-medium text-hotel-text-primary font-mono">{b.lot}</td>
                    ...
                    <td className="py-2 px-2">{b.puv.toLocaleString()}</td>
